...
class SavedHouseListings extends StatelessWidget {
  const SavedHouseListings({Key? key}) : super(key: key);
                ...
                builder: (context, houseData, child) =>
                    houseData.savedHouses.isEmpty
                        ...
                        : GridView.count(
                            ...
                            mainAxisSpacing: 10,
                            crossAxisSpacing: 3,
                            children: houseData.savedHouses
                                .map(
